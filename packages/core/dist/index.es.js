...
const renderElementPlugins = (plugins, renderElementList) => elementProps => {
  let element;
...
const renderLeafPlugins = (plugins, renderLeafList) => leafProps => {
...
export { EditablePlugins, decoratePlugins, onDOMBeforeInputPlugins, onKeyDownPlugins, renderElementPlugins, renderLeafPlugins };
